...
- Crypto Offset :: 1 bit: Only used for payload encryption mode,
  see [[Payload Encryption Mode Processing]]. If set, the
  ...
  different to payload encryption mode.
...
NOTE: For transport mode -- As mentioned at the end of [[Transport Mode Processing]],
