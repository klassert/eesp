...
SHOULD be used instead. A detailed discussion about the problems of the
ESP protocol can be found in
...
for e.g. optional Sequence Number. When present it is full 64bit
